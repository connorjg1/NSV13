//NSV13 - HoP renamed, MAA added, Nanotrasen Liaison Added
...
/proc/get_full_job_name(job)
  ...
  var/static/regex/ntr_expand  = new("ntr")
	var/static/regex/rd_expand = new("rd")
	var/static/regex/ce_expand = new("ce")
	var/static/regex/qm_expand = new("qm")
	var/static/regex/sec_expand = new("(?<!security )officer")
	var/static/regexengi_expand = new("(?<!station )engineer")
  ...
  job = ntr_expand.Replace(job, "nanotrasen Liaison")
